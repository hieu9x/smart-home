...
import com.example.myapplication.DeviceActivity.AddModule2;
...
public class LivingRoom extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvAddDevice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent AddDeviceActivity = new Intent(getApplicationContext(), AddModule2.class);
    ...
    private void innit(){
        tvText = findViewById(R.id.tvText2);
        btnSpeak = findViewById(R.id.btnSpeak2);
        tvUser = findViewById(R.id.TextViewUser2);
        tvLogout= findViewById(R.id.TextViewLogout2);
        tvAddDevice=findViewById(R.id.TextViewdevice2);
        btnBack=findViewById(R.id.btnBack);
        btnOnLight= findViewById(R.id.btnOnLight);
        btnOffLight= findViewById(R.id.btnOffLight);
        btnOnTV=findViewById(R.id.btnOnTV);
        btnOffTV= findViewById(R.id.btnOffTV);
        btnOffFan= findViewById(R.id.btnOffFan);
        btnOnFan=findViewById(R.id.btnOnFan);
        imgLight=findViewById(R.id.imageViewLight);
        imgFan=findViewById(R.id.imageViewFan);
        imgTV=findViewById(R.id.imageViewTV);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    for (UserAndModule uAD : userAndDeviceList) {
                        String module2 = uAD.getModule2();
                        DatabaseReference data_user = FirebaseDatabase.getInstance().getReference("module/module2").child(module2);
