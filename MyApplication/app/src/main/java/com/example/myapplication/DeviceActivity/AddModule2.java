...
public class AddModule2 extends AppCompatActivity {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(snapshot.exists()) {
                                ...
                                for (UserAndModule uAD : userAndDeviceList) {
                                    ...
                                    databaseReference.child(userId).child("module2").setValue(AddMac);
                                    Toast.makeText(getApplicationContext(), "successfully", Toast.LENGTH_LONG).show();
                                    Intent Main_Activity = new Intent(getApplicationContext(), LivingRoom.class);
